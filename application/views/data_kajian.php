  <div class="box box-success box-solid">
    <div class="box-header with-border">
      <h3 class="box-title">Data Jadwal Kajian </h3> <?=date('Y-m-d H:i:s')?>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th width="10%"><center>Judul Kajian</center></th>
                        <th width="20%"><center>Deskripsi Kajian</center></th>
                        <th width="10%"><center>Tanggal Kajian</center></th>
                        <th width="5%"><center>Waktu Kajian</center></th>
                        <th width="10%"><center>Pengisi Kajian</center></th>
                        <th width="20%"><center>Poster Kajian</center></th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><center>
                          ...
                          <a href="<?php echo site_url('kajian/broadcast_kajian/'. $row->id_kajian); ?>" class="btn btn-info-btn-sm"><i class="fa fa-send"></i>broadcast notif</a>
                            </center>
                        </td> 
                      </tr>
                      <?php endforeach; ?>         
